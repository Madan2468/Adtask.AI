  ...
  return (
    <section className="relative py-20 px-4 bg-[#050506] overflow-hidden">
      ...
      <div className="absolute inset-0 flex justify-center items-center pointer-events-none">
        <div className="w-[700px] h-[700px] bg-[#4c5fd5] opacity-15 blur-[280px] rounded-full"></div>
      </div>
      ...
      <div className="relative max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        {plans.map((plan, index) => (
          <motion.div
            ...
            className="relative bg-[#13131a] rounded-xl p-8 border border-gray-800 hover:border-[#4c5fd5] transition-all shadow-lg hover:shadow-[#4c5fd5]/40"
          >
            {/* Softer Per-Card Glow Effect */}
            <div className="absolute inset-0 bg-[#4c5fd5] opacity-10 blur-[180px] rounded-xl pointer-events-none"></div>

            <h3 className="relative text-xl font-semibold text-white mb-4">{plan.name}</h3>
